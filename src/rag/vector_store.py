...
class VectorStore:
    ...
    def __init__(
        ...
        self.metadata_path = (
            self.storage_dir / "metadata.npy"
        )

        self.embeddings = None
        self.metadata = None

        # Automatically load an existing vector store.
        if (
    ...
    def search(
        ...
        Returns chunk metadata together with
        similarity scores.
        """
...
# -------------------------------------------------------------------
# Standalone vector-store build/test
# -------------------------------------------------------------------
